...
class YoutubeVideos extends Component{
    constructor(){
       ...
       onFormSubmit= async e=>{
        ...
        console.log(formDataObj.videoename)
    ...
    const configuration = new Configuration({
      ...
      openai.createCompletion( {
        ...
        prompt: `generate youtube videos for the following topic: ${formDataObj.videoename}`  ,
        temperature: 0.7,
        max_tokens: 256,
        top_p: 1,
        frequency_penalty: 0,
      ...
      .then((response)=>{
        ...
        this.setState({
            heading: `AI youtube videos suggestions for:${formDataObj.videoename}`,
       ...
       render(){
        return (
            ...
            <br/>
            <br/>
            <h1>Generate youtube videos </h1>
            <h4>Generate youtube videos about sex education, simply type any key term </h4>
            <br/>
            <br/>
