...
class Tweet extends Component{
    constructor(){
       ...
       onFormSubmit= async e=>{
        ...
        console.log(formDataObj.tweetname)
    ...
    const configuration = new Configuration({
      ...
      openai.createCompletion( {
        ...
        prompt: `tweets for the following topic: ${formDataObj.tweetname}`  ,
        temperature: 0.7,
        max_tokens: 256,
        top_p: 1,
        frequency_penalty: 0,
      ...
      .then((response)=>{
        ...
        this.setState({
            heading: `AI tweet suggestions for:${formDataObj.tweetname}`,
       ...
       render(){
        return (
            ...
            <h4>Generate tweets about sex education, simply type any key term </h4>
            <br/>
            <br/>
